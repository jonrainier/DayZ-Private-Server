if (isServer) then {
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [5749.7417, 4099.6704, -8.392334e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_399 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [5738.4092, 4094.8413, 6.1035156e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_401 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [5721.3667, 4130.4922, 6.8664551e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_403 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5731.2964, 4127.3643, -0.00024414063], [], 0, "CAN_COLLIDE"];
	  _vehicle_406 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5737.1704, 4123.252, -0.00011444092], [], 0, "CAN_COLLIDE"];
	  _vehicle_408 = _this;
	  _this setDir -170.19336;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5739.8633, 4117.3682, 7.6293945e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_410 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5749.9834, 4102.6377, 4.5776367e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_412 = _this;
