if (isServer) then {
	...
	if (true) then
	{
	  _this = createVehicle ["UAZWreck", [5802.0796, 5216.9868, -0.1246307], [], 0, "CAN_COLLIDE"];
	  _vehicle_375 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["UralWreck", [5798.4321, 5161.209, 4.5776367e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_378 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5796.3213, 5168.3052, -0.00012207031], [], 0, "CAN_COLLIDE"];
	  _vehicle_381 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5794.877, 5157.9111, -0.00021362305], [], 0, "CAN_COLLIDE"];
	  _vehicle_383 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5792.832, 5163.8003, -4.5776367e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_385 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5802.4307, 5213.1123, -0.00016784668], [], 0, "CAN_COLLIDE"];
	  _vehicle_387 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [5800.0649, 5220.5977, -3.0517578e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_389 = _this;
	  _this setDir -99.565521;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [5804.439, 5215.0063, -0.0001373291], [], 0, "CAN_COLLIDE"];
	  _vehicle_392 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [5799.7075, 5164.0625, 0], [], 0, "CAN_COLLIDE"];
	  _vehicle_394 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [5795.9951, 5165.9434, 1.5258789e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_396 = _this;
