if (isServer) then {
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [4212.3784, 6755.0444, 6.1035156e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_361 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [4220.8774, 6743.3584, -9.1552734e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_363 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [4220.0347, 6739.5332, 3.0517578e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_366 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [4215.8643, 6759.1436, 3.0517578e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_368 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [4232.8799, 6753.3657, -0.00018310547], [], 0, "CAN_COLLIDE"];
	  _vehicle_370 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [4230.6279, 6744.4331, 3.0517578e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_372 = _this;
