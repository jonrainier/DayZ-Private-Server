if (isServer) then {
	...
	if (true) then
	{
	  _this = createVehicle ["Mass_grave", [6237.6729, 3366.7668, -8.2015991e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_415 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [6242.4287, 3364.9336, -0.00012016296], [], 0, "CAN_COLLIDE"];
	  _vehicle_418 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [6242.5146, 3368.2773, 9.5367432e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_420 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [6236.5488, 3362.2656, 0.00039291382], [], 0, "CAN_COLLIDE"];
	  _vehicle_422 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [6232.0386, 3368.0271, -0.00010108948], [], 0, "CAN_COLLIDE"];
	  _vehicle_425 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [6240.8916, 3363.1448, -2.8610229e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_427 = _this;
