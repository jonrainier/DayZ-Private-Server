if (isServer) then {
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [10044.766, 4155.1172, 0.00061035156], [], 0, "CAN_COLLIDE"];
	  _vehicle_235 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [10037.467, 4167.7607, -0.00018310547], [], 0, "CAN_COLLIDE"];
	  _vehicle_237 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10040.509, 4159.4536, 1.9073486e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_240 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10008.558, 4198.1191, 0.00020217896], [], 0, "CAN_COLLIDE"];
	  _vehicle_242 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [9981.3945, 4218.0845, 5.7220459e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_244 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [9970.2891, 4214.0723, 0.00016021729], [], 0, "CAN_COLLIDE"];
	  _vehicle_246 = _this;
	  _this setDir -212.14496;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [9972.3984, 4216.5981, -9.5367432e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_248 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [9980.2734, 4168.4639, 1.9073486e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_250 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10005.476, 4147.1729, -3.0517578e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_252 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [9975.0391, 4217.8608, -3.4332275e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_255 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [10005.835, 4200.8569, 4.9591064e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_257 = _this;
