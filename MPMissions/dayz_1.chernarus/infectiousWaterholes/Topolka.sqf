if (isServer) then {
	...
	if (true) then
	{
	  _this = createVehicle ["HMMWVWreck", [10336.892, 3654.115, -0.00019836426], [], 0, "CAN_COLLIDE"];
	  _vehicle_206 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [10336.825, 3650.8271, -2.2888184e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_208 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10336.369, 3657.344, 0.00030899048], [], 0, "CAN_COLLIDE"];
	  _vehicle_211 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10336.521, 3648.813, -0.00057220459], [], 0, "CAN_COLLIDE"];
	  _vehicle_213 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["UralWreck", [10276.451, 3771.7332, -3.8146973e-006], [], 0, "CAN_COLLIDE"];
	  _vehicle_216 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [10271.492, 3768.1182, 1.5258789e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_219 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body1", [10281.723, 3764.1689, -0.00010681152], [], 0, "CAN_COLLIDE"];
	  _vehicle_221 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10272.653, 3770.627, -6.4849854e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_224 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10273.537, 3767.8638, -3.4332275e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_226 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10277.839, 3765.0146], [], 0, "CAN_COLLIDE"];
	  _vehicle_228 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10280.47, 3766.6904, -1.9073486e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_230 = _this;
	...
	if (true) then
	{
	  _this = createVehicle ["Body2", [10278.315, 3767.0195, -5.7220459e-005], [], 0, "CAN_COLLIDE"];
	  _vehicle_232 = _this;
